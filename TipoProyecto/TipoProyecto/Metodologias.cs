...
{
    public partial class Metodologias : Form
    {
        int Estado;
        ...
        private void Metodologias_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_Guardar_Click(object sender, EventArgs e)
        {
            switch (Estado)
            {
                case 1:
                    ...
                    {
                        cl.EjecutarQuery("INSERT INTO METODOLOGIAS (Nombre, Descripcion) VALUES ('" + Txt_Nombre.Text + "','" + Txt_Descripcion.Text + "')");
                    }              
                    break;
                ...
                case 2:
                   ...
                   if(HuboBusqueda == false)
                   ...
                   else
                    {
                        ...
                        {
                            cl.EjecutarQuery("DELETE FROM METODOLOGIAS WHERE idMetodologias = " + Convert.ToInt32(Txt_Codigo.Text));
                        }
                    }
                ...
                case 3:
                    ...
                    else
                    {
                        ...
                        {
                            cl.EjecutarQuery("UPDATE METODOLOGIAS SET Nombre = '" + Txt_Nombre.Text + "', Descripcion = '" + Txt_Descripcion.Text + "' WHERE idMetodologias = " + Convert.ToInt32(Txt_Codigo.Text));
                        }
                    }
        ...
        private void Btn_Buscar_Click(object sender, EventArgs e)
        {
            ...
            {
                cl.ObtieneMetodologia(Convert.ToInt32(Txt_Codigo.Text), Txt_Nombre, Txt_Descripcion);
            }
            HuboBusqueda = true;
            Txt_Codigo.Enabled = true;
        }
